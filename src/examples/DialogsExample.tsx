...
import ExampleDialogWithPayload from './ExampleDialogWithPayload'
import ExampleDialogWithResult from './ExampleDialogWithResult'
import { lazy, useState } from 'react'

const ExampleDialog2 = lazy(() => import('./ExampleDialog2'))
